...
try {
	...
	dv_handler110.prototype = dv_baseHandlerIns;
dv_handler110.prototype.constructor = dv_handler110;

    var dv_handlersDefs = [{handler: new dv_handler110(), minRate: 0, maxRate: 10}];
